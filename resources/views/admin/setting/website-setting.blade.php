        ...
        <form action="{{route('website.setting.store')}}" method="post" enctype="multipart/form-data">
            ...
            <div class="grid grid-cols-12 gap-4 ">
                ...
                <div class="col-span-12 lg:col-span-4 p-2 shadow">
                    ...
                    <x-form.input label="Telephone No" value="{{$site->telephone_no}}"  name="telephone_no" />
                    <x-form.input label="Mobile No" value="{{$site->mobile_no}}"  name="mobile_no" />
                    <x-form.input label="Instagram Link" value="{{$site->instagram_link}}"  name="instagram_link" />
                    <x-form.input label="Facebook Link" value="{{$site->facebook_link}}"  name="facebook_link" /> --}}
                        ...
                        <div>
                            ...
                            <div class="flex rounded-lg shadow-sm">
                                <span
                                    class="px-4 inline-flex items-center min-w-fit rounded-s-md border border-e-0 border-gray-200 bg-gray-50 text-sm text-gray-500 dark:bg-gray-700 dark:border-gray-700 dark:text-gray-200"><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
                        ...
                        <div>
                            ...
                            <div class="flex rounded-lg shadow-sm">
                                <span
                                    class="px-4 inline-flex items-center min-w-fit rounded-s-md border border-e-0 border-gray-200 bg-gray-50 text-sm text-gray-500 dark:bg-gray-700 dark:border-gray-700 dark:text-gray-200"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-6 h-6">
                        ...
                        <div>
                            ...
                            <div class="flex rounded-lg shadow-sm">
                                <span
                                    class="px-4 inline-flex items-center min-w-fit rounded-s-md border border-e-0 border-gray-200 bg-gray-50 text-sm text-gray-500 dark:bg-gray-700 dark:border-gray-700 dark:text-gray-200"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-telephone-fill" viewBox="0 0 16 16">
                        ...
                        <div>
                            ...
                            <div class="flex rounded-lg shadow-sm">
                                <span
                                    class="px-4 inline-flex items-center min-w-fit rounded-s-md border border-e-0 border-gray-200 bg-gray-50 text-sm text-gray-500 dark:bg-gray-700 dark:border-gray-700 dark:text-gray-200"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-phone" viewBox="0 0 16 16">
                ...
                <div>
                    <label for="instagram_link"
                        class="block text-sm font-medium mb-2 text-gray-500 dark:text-gray-200">Instagram Link</label>
                    <div class="flex rounded-lg shadow-sm ">
                        <span
                            class="px-4  inline-flex items-center min-w-fit rounded-s-md border border-e-0 border-gray-200 bg-gray-50 text-sm text-gray-500 dark:bg-gray-700 dark:border-gray-700 dark:text-gray-200"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-instagram" viewBox="0 0 16 16">
                ...
                <div>
                    <label for="facebook_link"
                        class="block text-sm font-medium mb-2 text-gray-500 dark:text-gray-200">Facebook Link</label>
                    <div class="flex rounded-lg shadow-sm">
                        <span
                            class="px-4 inline-flex items-center min-w-fit rounded-s-md border border-e-0 border-gray-200 bg-gray-50 text-sm text-gray-500 dark:bg-gray-700 dark:border-gray-700 dark:text-gray-200"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-facebook" viewBox="0 0 16 16">
                ...
                <div class="col-span-12 lg:col-span-4 p-2 shadow">
                   ...
                   <div>
                    <label for="facebook_page_link"
                        class="block text-sm font-medium mb-2 text-gray-500 dark:text-gray-200">Facebook Page Link</label>
                    <div class="flex rounded-lg shadow-sm">
                        <span
                ...
                <div>
                    <label for="facebook_group_link"
                        class="block text-sm font-medium mb-2 text-gray-500 dark:text-gray-200">Facebook Group Link</label>
                    <div class="flex rounded-lg shadow-sm">
                        <span
                            class="px-4 inline-flex items-center min-w-fit rounded-s-md border border-e-0 border-gray-200 bg-gray-50 text-sm text-gray-500 dark:bg-gray-700 dark:border-gray-700 dark:text-gray-400"><svg
                                xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                ...
                <div>
                    <label for="youtube_link"
                        class="block text-sm font-medium mb-2 text-gray-500 dark:text-gray-200">Youtube Link</label>
                    <div class="flex rounded-lg shadow-sm">
                        <span
                ...
                <div>
                    <label for="intro_video_link"
                        class="block text-sm font-medium mb-2 text-gray-500 dark:text-gray-200">Intro Video Link</label>
                    <div class="flex rounded-lg shadow-sm">
                        <span
