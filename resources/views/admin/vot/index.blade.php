...
@section('breadcrumb')
    <div class="flex justify-between">
        <x-breadcrumb pageone=" Vot" />
        <x-button.button-plus route="{{ route('vot.create') }}" title="Create vot" />
    </div>
@endsection
@section('content')
                                ...
                                @forelse ($vots as $vot)
                                    <tr>
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-end text-sm font-medium">
                                            ...
                                            <x-table.crudactionbutton route="vot" :id="$vot->id" />
                                        </td>
                                    </tr>
                                @empty
                                    <td colspan="3"
