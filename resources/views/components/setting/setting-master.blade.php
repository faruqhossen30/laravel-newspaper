...
@section('content')
    ...
    <section class="container mx-auto bg-white bg-gray-100 border-2 rounded-md dark:bg-gray-800 dark:text-slate-400 dark:border-gray-500">
        <div class="flex items-center justify-between p-6 py-8 pl-4 border-b-2 border-gray-200 dark:border-gray-500">
            <div class="flex items-end">
                <h2 class="text-3xl font-semibold text-gray-500 dark:text-gray-200">Website Settings</h2>
                {{-- <span class="px-2 text-gray-400">1.0</span> --}}
            </div>
            <a href="{{route("website.setting")}}">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-10 h-10 text-gray-500 dark:text-gray-200 ">
        ...
        <div class="grid grid-cols-6">
            <div class="col-span-1 border dark:border-gray-500">
                {{-- sidebar start --}}
                <a href="#"
                    class="flex items-center p-2 text-base text-gray-700 border-b border-gray-200 shadow-sm dark:border-gray-500 hover:bg-gray-100 group dark:text-gray-200 dark:hover:bg-gray-700">
                ...
                <ul class="pb-2 space-y-2 border-t border-gray-200 shadow-sm dark:border-gray-500">
                    <li class="@if (request()->routeIs('chatsection')) bg-gray-300 dark:bg-gray-700 @endif">
                    ...
                    <li class="@if (request()->routeIs('website.setting')) bg-gray-300 dark:bg-gray-700 @endif">
                        <a href="{{route('website.setting')}}"
                            class="flex items-center p-2 text-base text-gray-900 border-b-2 dark:border-gray-500 hover:bg-gray-100 group dark:text-gray-200 dark:hover:bg-gray-700">
            ...
            <div class="col-span-5 border-b dark:border-gray-500">
                <h3 class="px-4 py-2 border-b-2 dark:border-gray-500 dark:text-gray-200">{{ $title ?? 'Setting' }}</h3>
                {{ $slot }}
            </div>
        </div>
        {{-- sidebar end --}}
